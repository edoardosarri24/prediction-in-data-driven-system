...
%%% type %%%
type(failure,(trace,)).
type(task1,(trace,releaseNumber_trace)).
type(task2,(trace,releaseNumber_trace)).
type(release_task1,(releaseNumber_trace,int)).
type(release_task2,(releaseNumber_trace,int)).
type(executionTime_task1_chunk1,(releaseNumber_trace,int)).
type(executionTime_task1_chunk2,(releaseNumber_trace,int)).
type(executionTime_task1_chunk3,(releaseNumber_trace,int)).
type(executionTime_task2_chunk1,(releaseNumber_trace,int)).
type(complete_task1,(releaseNumber_trace,int)).
type(complete_task2,(releaseNumber_trace,int)).
type(execute_task1_chunk1,(releaseNumber_trace,int)).
type(execute_task1_chunk2,(releaseNumber_trace,int)).
type(execute_task1_chunk3,(releaseNumber_trace,int)).
type(execute_task2_chunk1,(releaseNumber_trace,int)).
type(finish_task1_chunk1,(releaseNumber_trace,int)).
type(finish_task1_chunk2,(releaseNumber_trace,int)).
type(finish_task1_chunk3,(releaseNumber_trace,int)).
type(finish_task2_chunk1,(releaseNumber_trace,int)).
