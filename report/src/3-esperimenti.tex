...
\subsection{Risultati}
Nonostante aver aumentato la descrittività dei predicati, il sistema non è riuscito a trovare la regola corretta. Il sistema apprende, come si vede nei risultati dell'esperimento \href{https://github.com/edoardosarri24/prediction-in-data-driven-system/blob/main/my-experiments/12-add/result.txt}{add}, la soluzione \texttt{failure(A):- finish\_1\_3(A,D,C),execute\_2\_1(A,D,C),geq(C,1001)}, che però non è quella desiderata.